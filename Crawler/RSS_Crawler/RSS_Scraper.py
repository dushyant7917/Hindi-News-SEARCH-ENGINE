...
# Continuous scraping of web after gap of 2 minutes
while True:
    
    req = requests.get(RSS_urls[0], headers=agent)
    ...
    # Another scraping attempt for fresh news will be made after 5 seconds
    time.sleep(120)
